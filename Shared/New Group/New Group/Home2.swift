...
struct Home2: View {
    ...
    @State var posts : [Post] = [
        Post(postImage: "hamburgerSet", collectItem: [] ,stageNum:0),
        Post(postImage: "friedEggburgerSet", collectItem: [] ,stageNum:1),
        Post(postImage: "chickenSet", collectItem: [] ,stageNum:2)
    ]
        ...
        VStack(spacing: 15){
            ...
            Carousel(index: $currentIndex, items: posts, isOn : $isOn ){ post in
                GeometryReader{proxy in
                    ...
                    NavigationLink(destination: StartPage03View( collectItem: post.collectItem, isOn: $isOn, stageImage: .constant(post.postImage) )  ){
